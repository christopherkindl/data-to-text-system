...
class Node(object):
	def __init__(self, full_table, dict_in):
		...
		print('About to print func:')
		print(self.func)

		# row, num, str, obj, header, bool
		self.arg_type_list = APIs[self.func]["argument"]
		print('About to print arg_type_list')
		print(self.arg_type_list)
		self.arg_list = []
...
# root = Node(pd_table, logic)
	...
	def eval(self):
		...
		print('About to print self.func')
		print(self.func)
		print('About to print arg_list')
		print(self.arg_list)
...
def execute_all(json_in):
	...
	for data in tqdm(data_in):
		...
		num_all += 1
		logic = data["logic"]
		print('About to print logic')
		print(logic)

		table_header = data["table_header"]
		table_cont = data["table_cont"]
		print('About to print table_cont')
		print(table_cont)
		...
		root = Node(pd_table, logic)
		print('About to print pd_table')
		print(pd_table)
		print('About to print logic after PD_TABLE')
		print(logic)
		res = root.eval()
...
if __name__=='__main__':
	...
	data_path = "/Users/christopherkindl/working/nlp-dissertation/00_datasets/"
